...
class ShowAllLawyers extends StatefulWidget {
  const ShowAllLawyers({Key? key}) : super(key: key);

  @override
  _ShowAllLawyersState createState() => _ShowAllLawyersState();
}

class _ShowAllLawyersState extends State<ShowAllLawyers> {
  @override
